...
export class SentimentComponent implements OnInit {
  ...
  trainModel() {
    ...
    this.http.get<any>('/api/sentiment/train').subscribe({
  ...
  analyzeText() {
    ...
    this.http.post<any>('/api/sentiment/analyze', { text: this.userText }).subscribe({
      next: (res) => {
  ...
  analyzeBatch() {
    ...
    this.batchResults = [];
    this.summary = null;
    this.http.get<any>('/api/sentiment/batch').subscribe({
      next: (res) => {
